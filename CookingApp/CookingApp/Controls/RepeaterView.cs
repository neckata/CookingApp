namespace CookingApp.Controls
{
    ...
    {
        public static readonly BindableProperty ItemsSourceProperty = BindableProperty.Create(nameof(ItemsSource), typeof(IEnumerable), typeof(RepeaterView), new List<object>(), BindingMode.OneWay, propertyChanged: ItemsChanged);
